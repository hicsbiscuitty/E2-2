##the second assignment of E2 6/5 实验二第二次实验的三个任务项目上传以及实验结果截图
---
###任务1：首个Kotlin APP的构建截图（项目文件夹：E2-2-1MyFirstKotlinApp）
